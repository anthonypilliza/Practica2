<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" session="true" import="com.productos.seguridad.*" import="java.util.Date, java.text.SimpleDateFormat" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div class="agrupar">
        <section>
            ...
            <%
                    ...
                    String rol = "";
                    switch (perfil) {
                        case 1: rol = "USUARIO administrador"; break;
                        case 2: rol = "USUARIO cliente"; break;
                        case 3: rol = "USUARIO vendedor"; break;
                        case 4: rol = "USUARIO empleado"; break; 
